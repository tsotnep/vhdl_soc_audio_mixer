...
BEGIN OS
 ...
 PARAMETER BOOTARGS = console=ttyPS0,115200 root=/dev/ram rw initrd=0x800000,8M init=/init earlyprintk rootwait devtmpfs.mount=1
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = adau1761_audio_0
END
